...
import BookReceipt from "./admin/receipt/BookReceipt";
interface Props {
  bookDetail: {
    bookTitle: string;
    id: string;
...
const BorrowedBookCardReceiptButton = ({ bookDetail, borrowDetail }: Props) => {
  const receiptData = {
  ...
  return (
    <span className='bg-[#8B38484D] p-2 rounded-md'>
      <PDFDownloadLink
...
export default BorrowedBookCardReceiptButton;
