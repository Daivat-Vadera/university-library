...
const BookReceiptButton = ({ bookDetail, borrowDetail }: Props) => {
  const receiptData = {
  ...
  return (
    <>
      <div className='flex flex-row bg-light-300 py-4 px-2 rounded-lg cursor-pointer'>
        <span className='mr-2'>
          <svg
            width='24'
            height='24'
...
export default BookReceiptButton;
